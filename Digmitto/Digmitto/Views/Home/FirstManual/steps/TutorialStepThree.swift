...
struct TutorialStepThree: View {
    ...
    var body: some View {
        VStack(spacing: 5) {
            // General Action Text
            Text(LocalizedStringKey("tsth_general"))
                .font(.largeTitle)
                .fontWeight(.bold)
                .padding(.top, 1)
            ...
            VStack(alignment: .leading, spacing: 10) {
                ...
                Text(LocalizedStringKey("tsth_how_to_start_title"))
                    .font(.headline)
                    .foregroundColor(.blue)
                
                Text(LocalizedStringKey("tsth_instruction_step1"))
                    .font(.body)
                
                VStack(alignment: .leading, spacing: 5) {
                    Text(LocalizedStringKey("tsth_instruction_bullet1"))
                    Text(LocalizedStringKey("tsth_instruction_bullet2"))
                }
                .font(.callout)
                .foregroundColor(.gray)
                
                Text(LocalizedStringKey("tsth_instruction_step2"))
                    .font(.body)
                
                VStack(alignment: .leading, spacing: 5) {
                    Text(LocalizedStringKey("tsth_instruction_bullet3"))
                    Text(LocalizedStringKey("tsth_instruction_bullet4"))
                    Text(LocalizedStringKey("tsth_instruction_bullet5"))
                    Text(LocalizedStringKey("tsth_instruction_bullet6"))
                    Text(LocalizedStringKey(""))
                }
                .font(.callout)
                .foregroundColor(.gray)
            ...
            if !taskCompleted {
                NavigationLink(
                    destination: TaskView(
                        currentWord: NSLocalizedString("tsth_word_for_practice", comment: ""),
                    ...
                    PastelButton(
                        title: LocalizedStringKey("tsth_start_task"),
                ...
                Button(action: {
                    ...
                    PastelButton(
                        title: LocalizedStringKey("tsth_done"),
